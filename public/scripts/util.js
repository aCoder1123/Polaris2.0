...
const getMenuHTMLString = async (user, adminPage, db, admin = false) => {
	...
	return `
		<div id="sideMenuWrap" class="">
			...
			<a id="foodMenuWrap" class="menuWrap" href="${adminPage ? ".." : "."}/menu.html">
...
const getMenuSignInHTMLString = () => {
	return `
		<div id="sideMenuWrap" class="">
			...
			<div id="signInPrompt" class="menuWrap">Sign in to access Polaris.</div>
			<a id="signInWrap" class="menuWrap" href="index.html">
				<span class="material-symbols-outlined"> login </span><span class="menuText">Sign In</span>
			</a>
